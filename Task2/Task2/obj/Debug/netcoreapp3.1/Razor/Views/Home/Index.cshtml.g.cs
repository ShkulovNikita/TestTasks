#pragma checksum "D:\Tasks\TestTasks\Task2\Task2\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f50dfdea3901a4642de1133a3a50ea2fd92d5315"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f50dfdea3901a4642de1133a3a50ea2fd92d5315", @"/Views/Home/Index.cshtml")]
...
#nullable disable
        ...
        $(function updater() {
            ...
            if (");
#nullable restore
#line 147 "D:\Tasks\TestTasks\Task2\Task2\Views\Home\Index.cshtml"
           Write(updateTime);
...
#nullable disable
                ...
                if (feedsAreLoaded == true) {
                    ...
                    setTimeout(updater, ");
#nullable restore
#line 154 "D:\Tasks\TestTasks\Task2\Task2\Views\Home\Index.cshtml"
                                   Write(updateTime);
...
#nullable disable
 ...
 ");
                WriteLiteral(@"               // указать, что теперь элемент раскрыт
                nowOpened = true;
            }
